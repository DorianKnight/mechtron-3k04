...
static void Group44P_Default_Starting_State(const char_T mode[256])
{
  ...
  if ((Group44PACEMAKER_DW.temporalCounter_i1 >= (uint32_T)ceil
       (Group44PACEMAKER_P.input_aPulseWidth_Value)) && ((strcmp(&mode[0], "AOO")
        == 0) || (strcmp(&mode[0], "AAI") == 0))) {
    /* Constant: '<S2>/input_aPulseAmp' */
    Group44PACEMAKER_B.pulseDutyCycle = Group44PACEMAKER_P.input_aPulseAmp_Value
      / 5.0 * 100.0;
    if (strcmp(&mode[0], "AOO") == 0) {
      ...
      Group44PACEMAKER_B.cmpDutyCycle =
        Group44PACEMAKER_P.input_aSensitivity_Value / 5.0 * 100.0;
      guard1 = true;
    } else {
      guard3 = true;
    }
  ...
  if (guard3) {
    if ((Group44PACEMAKER_DW.temporalCounter_i1 >= (uint32_T)ceil
         (Group44PACEMAKER_P.input_vPulseWidth_Value)) && ((strcmp(&mode[0],
           "VOO") == 0) || (strcmp(&mode[0], "VVI") == 0))) {
      /* Constant: '<S2>/input_vPulseAmp' */
      Group44PACEMAKER_B.pulseDutyCycle =
        Group44PACEMAKER_P.input_vPulseAmp_Value / 5.0 * 100.0;
      if (strcmp(&mode[0], "VOO") == 0) {
        guard2 = true;
      } else if (strcmp(&mode[0], "VVI") == 0) {
        /* Constant: '<S2>/input_vSensitivity' */
        Group44PACEMAKER_B.cmpDutyCycle =
          Group44PACEMAKER_P.input_vSensitivity_Value / 5.0 * 100.0;
        guard2 = true;
      }
    }
  }
...
void Group44PACEMAKER_step(void)
{
  ...
  if (Group44PACEMAKER_DW.obj_c.SampleTime !=
      Group44PACEMAKER_P.input_ATR_CMP_DETECT_SampleTime) {
  ...
  if (Group44PACEMAKER_DW.obj.SampleTime !=
      Group44PACEMAKER_P.input_VENT_CMP_DETECT_SampleTim) {
    Group44PACEMAKER_DW.obj.SampleTime =
      Group44PACEMAKER_P.input_VENT_CMP_DETECT_SampleTim;
  }

  tmp_0 = MW_digitalIO_read(Group44PACEMAKER_DW.obj.MW_DIGITALIO_HANDLE);
  ...
  if (Group44PACEMAKER_DW.is_active_c6_Group44PACEMAKER == 0U) {
    ...
    switch (Group44PACEMAKER_DW.is_c6_Group44PACEMAKER) {
     case Group44PAC_IN_AtrialAlertPeriod:
      if (tmp) {
        ...
        Group44PACEMAKER_B.VENT_GND_CTRL = false;
                 ...
                 ((Group44PACEMAKER_P.input_LRL_Value -
                   Group44PACEMAKER_P.input_ARP_Value) -
                  Group44PACEMAKER_P.input_aPulseWidth_Value)) {
        Group44PACEMAKER_B.FRONTEND_CTRL = false;
        Group44PACEMAKER_DW.is_c6_Group44PACEMAKER =
        ...
        Group44PACEMAKER_B.FRONTEND_CTRL = true;
      }
      break;
     ...
     case IN_ChargeC22_Atrial_DischargeC2:
      ...
      if ((Group44PACEMAKER_DW.temporalCounter_i1 >= (uint32_T)ceil
           (Group44PACEMAKER_P.input_LRL_Value -
            Group44PACEMAKER_P.input_aPulseWidth_Value)) && (strcmp
        ...
        Group44PACEMAKER_B.ATR_GND_CTRL = false;
                  ...
                  (Group44PACEMAKER_P.input_ARP_Value)) && (strcmp
     ...
     case IN_ChargeC22_Ventricular_Discha:
      ...
      if ((Group44PACEMAKER_DW.temporalCounter_i1 >= (uint32_T)ceil
           (Group44PACEMAKER_P.input_LRL_Value -
            Group44PACEMAKER_P.input_vPulseWidth_Value)) && (strcmp
        ...
        Group44PACEMAKER_B.VENT_PACE_CTRL = true;
                  ...
                  (Group44PACEMAKER_P.input_VRP_Value)) && (strcmp
     ...
     case Group44PACEMAKER_IN_PaceAtria:
      ...
      Group44PACEMAKER_B.VENT_GND_CTRL = false;
      Group44PACEMAKER_B.VENT_PACE_CTRL = false;
      tmp_1 = (uint32_T)ceil(Group44PACEMAKER_P.input_aPulseWidth_Value);
     ...
     case Group44PACEMAK_IN_PaceVentricle:
      ...
      Group44PACEMAKER_B.VENT_GND_CTRL = false;
      Group44PACEMAKER_B.VENT_PACE_CTRL = true;
      tmp_1 = (uint32_T)ceil(Group44PACEMAKER_P.input_vPulseWidth_Value);
      if (((Group44PACEMAKER_DW.temporalCounter_i1 >= tmp_1) && (strcmp
            (&Group44PACEMAKER_P.mode_String[0], "VOO") == 0)) ||
          ((Group44PACEMAKER_DW.temporalCounter_i1 >= tmp_1) && (strcmp
            (&Group44PACEMAKER_P.mode_String[0], "VVI") == 0))) {
     ...
     default:
      ...
      if (tmp_0) {
        ...
        Group44PACEMAKER_B.VENT_GND_CTRL = true;
                 ...
                 ((Group44PACEMAKER_P.input_LRL_Value -
                   Group44PACEMAKER_P.input_VRP_Value) -
                  Group44PACEMAKER_P.input_vPulseWidth_Value)) {
        Group44PACEMAKER_B.FRONTEND_CTRL = false;
        Group44PACEMAKER_DW.is_c6_Group44PACEMAKER =
          Group44PACEMAK_IN_PaceVentricle;
        Group44PACEMAKER_DW.temporalCounter_i1 = 0U;

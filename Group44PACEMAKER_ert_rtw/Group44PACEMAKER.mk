###########################################################################
## Makefile generated for component 'Group44PACEMAKER'. 
## 
## Makefile     : Group44PACEMAKER.mk
## Generated on : Sun Oct 16 16:39:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Group44PACEMAKER.elf
...
COMPILER_COMMAND_FILE     = Group44PACEMAKER_comp.rsp
CMD_FILE                  = Group44PACEMAKER.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Group44PACEMAKER.elf
...
DEFINES_STANDARD = -DMODEL=Group44PACEMAKER -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o Group44PACEMAKER.o Group44PACEMAKER_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group44PACEMAKER.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/Group44PACEMAKER.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group44PACEMAKER_data.o : $(START_DIR)/Group44PACEMAKER_ert_rtw/Group44PACEMAKER_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"

###########################################################################
## Makefile generated for component 'Group44PACEMAKER_Debug_Requirements_Flashing'. 
## 
## Makefile     : Group44PACEMAKER_Debug_Requirements_Flashing.mk
## Generated on : Thu Oct 20 14:05:56 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Group44PACEMAKER_Debug_Requirements_Flashing.elf
...
PRODUCT_NAME              = Group44PACEMAKER_Debug_Requirements_Flashing
MAKEFILE                  = Group44PACEMAKER_Debug_Requirements_Flashing.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Admin/OneDrive/Desktop/FILESY~1/McMaster/THIRDY~1/MECHTR~1/Github/MECHTR~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Group44PACEMAKER_Debug_Requirements_Flashing_comp.rsp
CMD_FILE                  = Group44PACEMAKER_Debug_Requirements_Flashing.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Group44PACEMAKER_Debug_Requirements_Flashing.elf
...
DEFINES_STANDARD = -DMODEL=Group44PACEMAKER_Debug_Requirements_Flashing -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group44PACEMAKER_Debug_Requirements_Flashing.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/Group44PACEMAKER_Debug_Requirements_Flashing.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group44PACEMAKER_Debug_Requirements_Flashing_data.o : $(START_DIR)/Group44PACEMAKER_Debug_Requirements_Flashing_ert_rtw/Group44PACEMAKER_Debug_Requirements_Flashing_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"

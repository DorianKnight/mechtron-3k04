 ...
 *
 * File: Group44PACEMAKER_Debug_Requirements_Flashing.h
 *
...
#ifndef RTW_HEADER_Group44PACEMAKER_Debug_Requirements_Flashing_h_
#define RTW_HEADER_Group44PACEMAKER_Debug_Requirements_Flashing_h_
#ifndef Group44PACEMAKER_Debug_Requirements_Flashing_COMMON_INCLUDES_
#define Group44PACEMAKER_Debug_Requirements_Flashing_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "MW_digitalIO.h"
#include "MW_PWM.h"
#endif       /* Group44PACEMAKER_Debug_Requirements_Flashing_COMMON_INCLUDES_ */
...
#define Group44PACEMAKER_Debug_Requirements_Flashing_M (Group44PACEMAKER_Debug_Requi_M)
...
} B_Group44PACEMAKER_Debug_Requ_T;
...
typedef struct {
  ...
  uint8_T is_c6_Group44PACEMAKER_Debug_Re;/* '<S4>/Chart' */
  uint8_T is_active_c6_Group44PACEMAKER_D;/* '<S4>/Chart' */
} DW_Group44PACEMAKER_Debug_Req_T;

/* Parameters (default storage) */
struct P_Group44PACEMAKER_Debug_Requ_T_ {
...
struct tag_RTM_Group44PACEMAKER_Debu_T {
  const char_T * volatile errorStatus;
};

/* Block parameters (default storage) */
extern P_Group44PACEMAKER_Debug_Requ_T Group44PACEMAKER_Debug_Requir_P;

/* Block signals (default storage) */
extern B_Group44PACEMAKER_Debug_Requ_T Group44PACEMAKER_Debug_Requir_B;

/* Block states (default storage) */
extern DW_Group44PACEMAKER_Debug_Req_T Group44PACEMAKER_Debug_Requi_DW;

/* Model entry point functions */
extern void Group44PACEMAKER_Debug_Requirements_Flashing_initialize(void);
extern void Group44PACEMAKER_Debug_Requirements_Flashing_step(void);
extern void Group44PACEMAKER_Debug_Requirements_Flashing_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Group44PACEMAKER_Deb_T *const Group44PACEMAKER_Debug_Requi_M;
 ...
 *
 * '<Root>' : 'Group44PACEMAKER_Debug_Requirements_Flashing'
 * '<S1>'   : 'Group44PACEMAKER_Debug_Requirements_Flashing/InputPins'
 * '<S2>'   : 'Group44PACEMAKER_Debug_Requirements_Flashing/Inputs'
 * '<S3>'   : 'Group44PACEMAKER_Debug_Requirements_Flashing/OutputPins'
 * '<S4>'   : 'Group44PACEMAKER_Debug_Requirements_Flashing/Stateflow'
 * '<S5>'   : 'Group44PACEMAKER_Debug_Requirements_Flashing/Stateflow/Chart'
 */
#endif          /* RTW_HEADER_Group44PACEMAKER_Debug_Requirements_Flashing_h_ */
